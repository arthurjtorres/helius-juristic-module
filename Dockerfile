...
COPY --from=builder /modulo-juridico/package*.json ./
COPY --from=builder /modulo-juridico/build ./build
COPY --from=builder /modulo-juridico/node_modules ./node_modules
